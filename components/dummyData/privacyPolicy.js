...
const introduction = [
  "We, SchoolX having its registered office House 427F Street 2B overseas sector 2 Bahria Town Phase 8 Rawalpindi, Pakistan, the creator of this Privacy Policy ensure our firm commitment to your privacy vis-à-vis the protection of your priceless information. In order to endow you with our uninterrupted use of services, we may collect and, in some circumstances, disclose information about you. To enhance better protection of your privacy we provide this notice explaining our information practices and the choices you can make about the way your information is collected and used.",
  "All visitors to SchoolX.com (Website) are advised to read and understand our Privacy Policy carefully, as by accessing the Website you agree to be bound by the terms and conditions of the Privacy Policy and consent to the collection, storage and use of information relating to you as provided herein.",
  "If you do not agree with the terms and conditions of our Privacy Policy, including in relation to the manner of collection or use of your information, please do not use or access the Site. If you have any questions or concerns regarding this privacy policy, you should contact our Customer Support Desk at info@schoolx.pk",
...
const definitions = {
  ...
  list: [
    ...
    "“Website” shall mean and refer to SchoolX.com created by SchoolX Technologies Private Limited",
...
const overview = {
  ...
  list: [
    ...
    "The Website also requests for permissions while linking your SchoolX Account with your Social account, the information shall be collected directly from your social media account in the event You have granted the permission to link such accounts.",
  ],
};
...
const externalLinks = {
  title: "External Links On Website",
  list: [
...
const questions = {
  title: "Questions And Suggestions And Grievance Officer",
  list: [
    ...
    "Grievance officer: Allan Fakir",
    <>
      Email: <a href="mailto:info@schoolx.pk">info@schoolx.pk</a>
    </>,
  ],
};
