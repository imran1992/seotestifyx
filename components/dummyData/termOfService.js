...
const introduction = [
  "www.schoolx.pk is an online portal, owned by SchoolX Technologies Private Limited, a private limited company incorporated in Pakistan, for imparting education in relation to preparation of entrance exams for engineering colleges and institutions in Pakistan through digital modules.",
];

const general = {
  title: "General",
  list: [
    "“www.schoolx.pk” (hereinafter, the “Website”, or “Site”) and the mobile learning application in relationthereto (“Application”) is owned and operated by SchoolX Technologies Private Limited (“Company”,“SchoolX”), a company incorporated under the Companies Act, having its registered office at Rawalpindi, Pakistan. You are advised to read andunderstand these Terms carefully as your use/access/browsing of the Application and/or Website or anyservice in relation to the usage of the Application/Website (“Services”) and/or any product provided bythe Company in relation to the usage of the Application/Website, including SD cards, tablets or otherstorage or transmitting device (“Product(s)) and/or registration pertaining to subscription for theApplication, with or without payment/with or without subscription, (“Subscription”) through any meansshall signify Your acceptance of the Terms and Your agreement to be legally bound by the same. Theseterms and conditions (“Terms of Use”) shall also apply to the Subscriptions with the package of anyProduct provided by SchoolX These terms are to be read along with the Privacy Policy and any otherpolicies on the Website. This document is an electronic record published in accordance with theprovisions of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishingthe Rules and Regulations, Privacy Policy and Terms of Service for access or usage of the website andbeing generated by a computer system, it does not require any physical or digital signatures. For thepurpose of these Terms of Use, along with any amendments to the same, and wherever the context sorequires “You”, “Your” or “User” refer to the person visiting, accessing, browsing through and/or usingthe Website/Application or using the Services or Products, at any point in time. The term “We”, “Us”,“Our” shall mean and refer to the Website and/or the Company, depending on the context. The headingsof each section in this Agreement are only for the purpose of organising the various provisions under thisAgreement in an orderly manner. These headings shall not be used by either party to interpret theprovisions contained under them in any manner. Further, the headings have no legal or contractual value.We hold the sole right to modify the Terms of Service without prior permission from You or providing notice to You. The relationship creates on You a duty to periodically check the Terms of Service and stayupdated on its requirements. If You continue to use the Website or avail any of its services withoutregistration, following such change, this is deemed as consent by You to the so amended policies. Yourcontinued use of the Website is conditioned upon your compliance with the Terms of Service, includingbut not limited to compliance with the Terms of Service even after alterations, if any.",
  ],
};

const servicesAndTablet = {
  title: "Services and Tablet Overview",
  list: [
    ...
    "The Company shall have no responsibility for any loss or damage caused to tablet or any other hardware and / or software and/or any other instrument, including loss of data or effect on the processing speed,resulting from Your use of our Products and Services.",
    "The User must specify the address to which the shipment has to be made at the time of purchase of the Service and the Product. All Product(s) shall be delivered directly to the address as specified at the point of ordering and the User cannot, under any circumstances whatsoever, change the address after the order is processed. Any inconsistencies in name or address will result in non-delivery of the Product(s), and the Company shall not have any liability with respect to any loss suffered by the User.You acknowledge and agree that the Company is not the manufacturer of the Product and/or anytablet/medium/hardware that may be provided to you by the Company, and hence, any defect or damage relating to any Product shall be reported to the manufacturer whose details shall be specified on the packaging. The Company shall not be in any manner responsible for such damage/defect. The Companydoes not provide any guarantee or warranty relating to any Product, including anytablet/medium/hardware.",
    "Once an order is booked along with the Product, and the Product is delivered to the customers place, no subsequent refund / return request shall be accepted by the Company or any of its distributor(s). For the policy pertaining to the return of Product(s) damaged in transit or at the time of delivery, kindly refer the instruction sheet available with suh Product(s).",
  ],
};
...
const registration = {
  title: "Registration",
  list: [
    "To use the services provided on the website and make purchases, it is compulsory to create an account. A User may create an account on the Website which shall collect only Your basic information. To create an account, you need to choose a username and password. You also have the option of linking your social media accounts, such as Your Facebook or Google Plus account with the SchoolX account, to create your SchoolX Account. You must keep your account and registration details current and correct for communications related to your purchases from the Website.",
    "At the time of registration, the Company shall collect the following personally identifiable information about you: Name - including first and last name, email address, mobile phone number and other contact details, demographic profile (like your age, gender, address, etc.,). If you choose to link your social media account with your SchoolX Account, we collect basic information about you from those social media platforms, such as: name, age, gender, location and e-mail address. Information collected about you is subject to the Privacy Policy of the Company, which may be read as part and parcel of these Terms of Use.",
...
const eligibility = {
  title: "Eligibility",
  list: [
    "Services on the Site would be available to only select geographies in Pakistan. Persons who are “incompetent to contract” within the meaning of the Pakistann Contract Act, 1872 including minors, un-discharged insolvents etc. are not eligible to use the Site.",
    "However, if you are a minor, i.e. under the age of 18 years and over the age of 13 years, you may use the Site under the supervision of a parent or legal guardian who agrees to be bound by these Terms of Use.SchoolX reserves the right to terminate or refuse your registration, or refuse to permit access to the Site, if it is discovered or brought to its notice that you are a minor.",
  ],
};
  ...
  list: [
    ...
    "You hereby agree and undertake not to host, display, upload, modify, publish, transmit, update or share any information which:",
    {
      list: [
        ...
        "threatens the unity, integrity, defence, security or sovereignty of Pakistan, friendly relations with foreign states, or public order or causes incitement to the commission of any cognizable offence or prevents investigation of any offence or is insulting any other nation; or",
...
const payment = {
  ...
  list: [
    ...
    {
      list: [
        "Easypaisa Debit & Credit Card payments",
        "Easypaisa mobile & OTC payments",
        "Jazzcash Debit & Credit Card payments",
        "Jazzcash mobile & OTC payments",
        ...
        "Netbanking/Direct Debit payments from select banks in Pakistan. A list of available options will be made available at the time of the Purchase.",
        "Cash Pick Up",
        "Payment Wallets",
      ],
    },
    ...
    "User will be charged a non-refundable enrollment fee along with the package subscription fee and the tablet cost (if the same is included in the Subscription package). This is a one-time fee for providing access to the SchoolX platform and for guidance on using the platform (e.g., activation help, setting up student's syllabus), counselling service if availed, cost of tablet (in case tablet device is included in the Subscription package), cost for user verification and cost of payment gateway charges.",
  ],
};
...
const userObligations = {
  ...
  list: [
    ...
    {
      list: [
        "You are bound not to cut, copy, distribute, modify, recreate, reverse engineer, distribute,disseminate, post, publish or create derivative works from, transfer, or sell any information orsoftware obtained from the website. With our prior permission limited use may be allowed.For the removal of doubt, it is clarified that unlimited or wholesale reproduction, copying ofthe content for commercial or non-commercial purposes and unwarranted modification of dataand information within the content of the Website is not permitted.",
        "You agree not to access (or attempt to access) the Website and/or the materials or Services byany means other than through the interface that is provided by the website. The use of deep-link, robot, spider or other automatic device, program, algorithm or methodology, or anysimilar or equivalent manual process, to access, acquire, copy or monitor any portion of theWebsite or Content, or in any way reproduce or circumvent the navigational structure orpresentation of the Website, materials or any Content, to obtain or attempt to obtain anymaterials, documents or information through any means not specifically made availablethrough the Website. You acknowledge and agree that by accessing or using the Website orServices, You may be exposed to content from other users that You may consider offensive,indecent or otherwise objectionable. We disclaim all liabilities arising in relation to suchoffensive content on the Website. Further, You may report such offensive content.",
        "In places where this website allows you to post or upload data/information, You undertake toensure that such material is not offensive and in accordance with applicable laws. Further, Youundertake not to:",
        {
          list: [
        ...
        "You shall not engage in advertising to, or in solicitation of, other Users of the Website to buy or sell anyproducts or services, including, but not limited to, products or services related to that being displayed onthe Website or related to us. You may not transmit any chain letters or unsolicited commercial or junkemail to other Users via the Website. It shall be a violation of these Terms of Service to use anyinformation obtained from the Website in order to harass, abuse, or harm another person, or in order tocontact, advertise to, solicit, or sell to another person other than Us without Our prior explicit consent. We can (and You hereby expressly authorize Us to) disclose any information about You to law enforcement orother government officials, as we, in our sole discretion, believe it necessary or appropriate in connectionwith the investigation and/or resolution of possible crimes, especially those that may involve personalinjury. In order to protect Our Users from such advertising or solicitation, We reserve the right to restrictthe number of messages or emails which a user may send to other Users in any 24-hour period which Wedeem appropriate in our sole discretion. You understand that We have the right at all times to disclose anyinformation (including the identity of the persons providing information or materials on the Website) asnecessary to satisfy any law, regulation or valid governmental request. This may include, withoutlimitation, disclosure of the information in connection with investigation of alleged illegal activity orsolicitation of illegal activity or in response to a lawful court order or subpoena.",
        "We have no obligation to monitor the materials posted on the Website. We shall have the right to removeor edit any content that in its sole discretion violates, or is alleged to violate, any applicable law or eitherthe spirit or letter of these Terms of Service. Notwithstanding this right, YOU REMAIN SOLELYRESPONSIBLE FOR THE CONTENT OF THE MATERIALS YOU POST ON THE WEBSITE ANDIN YOUR PRIVATE MESSAGES. In no event shall We assume or have any responsibility or liability forany Content posted or for any claims, damages or losses resulting from the use of Content and/orappearance of Content on the Website. You hereby represent and warrant that You have all necessaryrights in and to all Content which You provide and all information it contains and that such Content shallnot infringe any proprietary or other rights of third parties or contain any libelous, tortuous, or otherwiseunlawful information.",
      ],
    },
  ],
};
...
const copyRight = {
  ...
  list: [
    "The Company, its suppliers and licensors expressly reserve all intellectual property rights in all text,programs, products, processes, technology, images, content and other materials which appear on the Site.Access to or use of the Site does not confer and should not be considered as conferring upon anyone anylicense to the Company or any third party’s intellectual property rights. All rights, including copyright, inand to the Site are owned by or licensed to the Company. Any use of the Site or its contents, includingcopying or storing it or them in whole or part is prohibited without the permission of the Company.",
    "You may not modify, distribute or re-post anything on the Site for any purpose. The names and logos andall related product and service names, design marks and slogans are the trademarks/service marks of the Company, its affiliates, its partners or its suppliers/service providers. All other marks are the property of their respective owners. No trademark or service mark license is granted in connection with the materials contained on the Site. Access to or use of the Site does not authorize anyone to use any name, logo or mark in any manner. References on the Site to any names, marks, products or services of third parties or hypertext links to third party sites or information are provided solely as a convenience to you and do notin any way constitute or imply the Company’s endorsement, sponsorship or recommendation of the third party, the information, its product or services.",
...
const disclaimer = {
  ...
  list: [
    ...
    "The website, services and other materials are provided by this website is on an 'as is' basis without warranty of any kind, express, implied, statutory or otherwise, including the implied warranties of title,non-infringement, merchantability or fitness for a particular purpose. Without limiting the foregoing,SchoolX makes no warranty that",
    {
      list: [
    ...
    "To the maximum extent permitted by applicable law, we will have no liability related to user content arising under intellectual property rights, libel, privacy, publicity, obscenity or other laws. SchoolX also disclaims all liability with respect to the misuse, loss, modification or unavailability of any user content.",
    "The user understands and agrees that any material or data downloaded or otherwise obtained through the website is done entirely at his/her own discretion and risk and he/she will be solely responsible for any damage to his/her computer systems or loss of data that results from the download of such material or data. We are not responsible for any typographical error leading to an invalid coupon. SchoolX accepts no liability for any errors or omissions, with respect to any information provided to you whether on behalf of itself or third parties.",
...
const hostingOfThirdParty = {
  title: "Hosting of Third Party Information",
  list: [
...
const counselling = {
  ...
  list: [
    "You agree that SchoolX Counsellor can create an account on SchoolX on your behalf during the counselling session.",
  ],
};
...
const contactUs = {
  ...
  list: [
    <>
      If you have any questions about this Agreement, the practices of SchoolX,
      or your experience with the Service, you can e-mail us at{" "}
      <a href="mailto:info@schoolx.pk">info@schoolx.pk</a>
    </>,
  ],
};
