...
import LectureCard from "@components/testphase/cards/lectureCard";
import CourseCard from "@components/testphase/cards/courseCard";
          ...
          <div className="filterDiv w-100 rounded p-3">
            ...
            <div className="w-100 d-flex justify-content-center">
              ...
              <button
                ...
                className="btn btn-primary btn-rounded btn-sm waves-effect waves-light filterBtn"
              >
                Filter
              </button>
              {!isEmpty(input) && (
