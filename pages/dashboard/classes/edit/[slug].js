...
const Dashboard = () => {
  ...
  const editClass = () => {
    setLoading(true);
    updateClass(_id, {name: name || nameX})
      .then((response) => {
  ...
  return (
    <main className={user.role === 'student' ? 'pl-0 pt-5 w-75 mx-auto mainStudent' : 'pt-5 mx-lg-5'}>
      <div className="container-fluid mt-5">
        <div className="row">
          <h2 className="h5 w-100 rounded p-2 mt-3 dashHeading">Edit class: <span className="headerSecondary">{nameX}</span></h2>
        </div>
        <div className="row">
          {notifMessage ? (
          ...
          <div className="container">
            <div className="text-center mt-4">
              <button
                ...
                onClick={(e) => { e.preventDefault(); editClass(); }}
