      ...
      <div className="container-fluid mt-5">
        <div className="row">
          <h2 className="h5 w-100 rounded p-2 mt-3 dashHeading">
            Lectures of tutor:{" "}
            <span className="headerSecondary">{user.name}</span>
          </h2>
        </div>
        <Notif
        ...
        <div className="row">
          {!isEmpty(lectures) &&
            filter(lectures.data, found => found.user._id === user._id).map(
              (
                {
                  _id,
                  user: ownerX,
                  ...
                  <div key={_id} className="col-md-6 my-4">
                    <div className="card card-cascade narrower">
                      <div
                        ...
                        className={
                          "view view-cascade lectureHeader gradient-card-header"
                        }
                      >
                        <h5
                          onClick={e => {
                            e.preventDefault();
                            Router.push(`${pathname}/view/${_id}`);
                          }}
                      ...
                      <h6 className="indigo-text mt-4 text-center">
                        {title}
                      ...
                      <div className="card-body text-center px-4">
                        <div className="list-group list-panel">
                          <div className="list-group-item d-flex justify-content-between">
                            ...
                            <span
                              onClick={() =>
                                Router.push(`/profile/${ownerX._id}`)
                              }
                              style={{
                                cursor: "pointer",
                                position: "relative",
                              ...
                              className="datetime text-white bg-primary"
                            >
                              {ownerX.name}
                            </span>
                          </div>
                          <div className="list-group-item d-flex justify-content-between">
                            ...
                            <span className="datetime text-secondary">
                              {startDate}
                            </span>
                          </div>
                          <div className="list-group-item d-flex justify-content-between">
                          ...
                          <div className="list-group-item d-flex justify-content-between">
                            ...
                            <span className="datetime text-secondary">
                              {price ? `Rs ${price.toLocaleString()}` : "FREE"}
                            </span>
                          </div>
                          {ownerX._id !== owner._id &&
                          ...
                          {endTime && meetingInfo.running[0] === "false" ? (
                            <div
                              className={"alert alert-info mt-4 mx-5"}
                              role="alert"
                            >
                              <i className="fa fa-info text-primary" /> Lecture
                              ended.
                            </div>
                          ) : null}
                          {/* <div className="mt-2">
                        ...
                        <ul className="list-unstyled list-inline font-small mt-3 d-flex justify-content-between px-4">
                          ...
                          <li className="list-inline-item">
                            <span title="subscribers" className="white-text">
                              <i className="fa fa-thumbs-up pr-1"> </i>
                              {subscribers.length}
                            </span>
                          </li>
                        </ul>
